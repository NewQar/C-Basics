...
main ()
{
	int t=100, night, SW=100, SF=100, DW=100, DF=100, EW=100, EF=100, choice=5, roomnumber;	//t=100 because the number of room will start with '100'.
	char room='s', view;
	string name;
		...
		cout <<endl;
			if ( room == 'S' || room == 's' )
			{
				...
				else
				{
					...
					while (cout << "How many nights : " && !(cin >>SWnite[SW])) {
