...
main ()
{
	int t=100, night, SW=100, SF=100, DW=100, DF=100, EW=100, EF=100, choice, roomnumber;	//t=100 because the number of room will start with '100'.
	char room, view;
	string name;
	float pricenight, price, gst, total, loop=1;	//loop=1 because the main menu of looping is until the user enter the 'exit' menu. When exited, loop=0 and looping will exit.
	...
	switch(choice)
	{
		...
		cin >> view;
			if(SW>102||SF>102||DW>102||DF>102||EW>102||EF>102)	//Function when the room is full
			{
